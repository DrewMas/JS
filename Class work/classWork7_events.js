...
// const swearWords = ['fuck', 'bullshit', 'motherfucker', 'asshole', 'dick head', 'bastard', 'wanker', 'bollocks', 'shit', 'bitch', 'son of a bitch', 'cunt', 'twat', 'crap'];
// const input = document.getElementById('input');
// const button = document.getElementById('btn');
//
// button.onclick = () => {
//     swearWords.forEach(value => {
//         if (input.value === value) alert('Shut up');
//     });
// }
...
// const swearWords2 = ['fuck', 'bullshit', 'motherfucker', 'asshole', 'dick head', 'bastard', 'wanker', 'bollocks', 'shit', 'bitch', 'son of a bitch', 'cunt', 'twat', 'crap'];
// const input2 = document.getElementById('input2');
// const button2 = document.getElementById('btn2');
//
// button2.onclick = () => {
//     for (const word of swearWords2) {
//         if (input2.value.includes(word)) alert(`Don't you dare to use ${word}`);
//     }
// }
